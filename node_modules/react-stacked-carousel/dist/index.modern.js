...
var styles = {"container":"_1Lxpd","cardCarousel":"_3tZKZ","carouselDefault":"_215Bn","leftButton":"_2ocTZ","rightButton":"_2YVEG","cardSummary":"_3kMpo","card":"_xsi02","active":"_3sodH","next":"_1uQwZ","prev":"_KqFRp","inactive":"_3hvs3","noTranslate":"_1HDdD"};
...
var setCardStatus = function setCardStatus(indexes, cardIndex, showSummary) {
  if (showSummary === void 0) {
    showSummary = false;
  }
...
var StackedCarousel = function StackedCarousel(_ref) {
  var showSummary = _ref.showSummary,
      style = _ref.style,
  ...
  var cardItems = showSummary ? [1].concat(children) : children || defaultCardItems;
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    if (showSummary && index === 0) {
      var cardsGallery = cardItems.slice(1);
      ...
      }, cardsGallery.map(function (cardItem, cardIndex) {
        return /*#__PURE__*/React.createElement("div", {
          key: cardItem.key,
