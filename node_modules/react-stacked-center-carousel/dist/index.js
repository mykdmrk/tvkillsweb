...
var StackedCarousel = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function StackedCarousel(props) {
    ...
    _this.onSwipe = function (e) {
      ...
      var transformPercentage = 1 - Math.pow(0.8, transformFactor);
    ...
    _this.onSwipeEnd = function (e) {
      ...
      var initalSwipeX = _this.state.initalSwipeX;
      ...
      var delta = Math.abs(swipeDistance);
      var swipeLeft = swipeDistance > 0;
      var swipeThreshold = _this.props.swipeThreshold || 50;

      _this.moveCarousel(delta <= swipeThreshold ? 0 : swipeLeft ? 1 : -1, true);
  ...
  _proto.render = function render() {
    ...
    }, renderedSlides.map(function (_ref7) {
      var opacity = _ref7.opacity,
          slideIndex = _ref7.slideIndex,
